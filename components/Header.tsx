...
const Header: React.FC<HeaderProps> = ({ onMenuClick, title, currentUser, notifications = [], onBellClick }) => {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 pl-2">
            <div className="hidden md:block text-right">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">{currentUser.role.replace('_', ' ')}</p>
            </div>
