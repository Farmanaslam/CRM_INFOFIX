  ...
  const filteredTasks = useMemo(() => {
    return tasks.filter((t) => {
      ...
      const matchesAssignee =
        filterAssignee === "all" || t.assignedToId === filterAssignee;
      ...
      <div className="space-y-6 pb-20 animate-in fade-in duration-700">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">
                Real-time task synchronization & team output.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={i}
              className="bg-white border border-slate-200 rounded-2xl p-5 group hover:border-indigo-300 transition-all shadow-sm"
            >
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest flex items-center gap-2">
                  <TrendingUp size={16} className="text-indigo-600" /> Activity
                  Breakdown
                </h3>
          ...
          <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-xl">
            ...
            <div className="space-y-4">
              {stats.leaderboard.slice(0, 5).map((staff, idx) => (
                <div
                  key={idx}
                  className="group flex items-center justify-between p-4 bg-white/5 rounded-3xl border border-transparent hover:border-white/10 transition-all"
                >
                  <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium">
                Audit logs and assignment summary
              </p>
            </div>
          </div>
                ...
                {filteredTasks.map((task) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-5">
                        <span className="bg-slate-100 text-slate-600 px-2.5 py-1 rounded-lg text-[10px] uppercase font-black tracking-wider border border-slate-200">
                          {task.type}
                        </span>
                      </td>
